    ...
    <v-container>
      <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-12">
          <v-carousel>
            <v-carousel-item
                v-for="image in restaurant.images" :key="image.id"
                v-bind:src="URL + image.name"
            >
            </v-carousel-item>
          </v-carousel>
        </div>
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            <p class="display-1 mb-0">{{ restaurant.name }}</p>
            <v-card-actions class="pa-0">
              <p class="headline font-weight-light pt-3">$65.00
            ...
            >
              ...
              <yandex-map
                  :settings="settings"
                  zoom="5"
                  style="width: 100%; max-width: 100%; height: 280px;"
                  :coords="coords"
              >
                <ymap-marker
        ...
        <div class="col-sm-12 col-xs-12 col-md-12">
          ...
          >
            ...
            <div class="row text-center">
              ...
              <div class="col-md-2 col-sm-4 col-xs-12 text-center" v-for="meal in restaurant.meals" :key="meal.id">
                <v-hover
                ...
                >
                  ...
                  >
                    <v-img
                        ...
                        height="200px"
                        v-bind:src="URL_MEAL + meal.profileImage"
                    >
...
export default {
  ...
  async mounted() {
    try {
      this.restaurant = await this.$store.dispatch('oneRestaurantAct', {id: this.$route.params.restaurantId})
    } catch {
      console.log('bad!')
    }
  },
  data: () => ({
    ...
    URL: 'http://localhost:3000/restaurant/image/',
    URL_MEAL: 'http://localhost:3000/meal/profileImage/',
    ...
    settings: {
      apiKey: '062e7db9-6c4e-4459-b340-9bd3a5834e31',
      lang: 'ru_RU',
      coordorder: 'latlong',
      version: '2.1'
    },
