    ...
    <v-container>
      <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-12">
          <v-carousel>
            <v-carousel-item
                v-for="image in meal.images" :key="image.id"
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
          ...
          <div class="pl-6">
            <p class="display-1 mb-0">{{ meal.name }}</p>
              ...
              <div class="col-md-2 col-sm-4 col-xs-12 text-center">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <v-card-title>Meal</v-card-title>
                    </v-img>
...
export default {
  ...
  async mounted() {
    try {
      this.meal = await this.$store.dispatch('oneMealAct', {id: this.$route.params.mealId})
    } catch {
      console.log('bad!')
    }
  },
  data: () => ({
    meal: new Meal(),
    URL: 'http://localhost:3000/meal/image/',
